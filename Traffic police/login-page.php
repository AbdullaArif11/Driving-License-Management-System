...
<header>
  ...
  <div class="navbar-start">
    ...
    <a class="btn btn-ghost normal-case text-xl" href="../index.html">D.L.M system</a>
  </div>
  ...
  <div class="hero bg-transparent backdrop-blur-sm h-500 max-w-[64.5rem] border-solid border-2 border-gray-200 rounded-2xl p-10 shadow-2xl text-white">
    <div class="hero-content flex-col lg:flex-row-reverse">
      ...
      <div class="text-center lg:text-left">
        <h1 class="text-4xl font-bold">Traffic Police Login Page!</h1>
        <p class="mt-6">Welcome to the Driving License Management System! Please log in using your unique Traffic Police ID and password to access the platform conveniently.</p>
        <p class="py-1">Thank you for your dedicated service in ensuring safer roads. We appreciate your valuable contributions.</p>
