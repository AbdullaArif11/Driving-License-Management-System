  ...
  <div class="hero bg-transparent backdrop-blur-sm h-500 max-w-[64.5rem] border-solid border-2 border-gray-200 rounded-2xl p-10 shadow-2xl text-white">
    <div class="hero-content flex-col lg:flex-row-reverse">
      ...
      <div class="text-center lg:text-left">
        <h1 class="text-4xl font-bold">Traffic Admin Login!</h1>
        <p class="mt-6">A quick reminder to the public users that this platform is specifically designed for authorized personnel only. Unauthorized access or attempts to breach the system's security protocols are strictly prohibited and may lead to legal consequences.</p>
