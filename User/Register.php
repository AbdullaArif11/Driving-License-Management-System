    ...
    <div class="dropdown">
      ...
      <ul tabindex="0" class="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52">
        ...
        <li>
          <a>Select User</a>
          <ul class="p-2">
            <li><a href="login-page.php">General User</a></li>
            <li><a href="../Traffic police/login-page.php">Traffic Police</a></li>
            <li><a href="../Traffic admin/login-page.php">Traffic Admin</a></li>
          </ul>
        </li>
