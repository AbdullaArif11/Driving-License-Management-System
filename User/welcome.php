    ...
    <div class="dropdown">
      ...
      <ul tabindex="0" class="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52">
        ...
        <li>
          <a>Select User</a>
          <ul class="p-2">
          <li><a href="http://localhost/Driving%20License%20Management/User/welcome.php#">Public user</a></li>
            <li><a href="http://localhost/Driving%20License%20Management/Traffic%20police/welcome.php">Traffic Police</a></li>
            <li><a href="http://localhost/Driving%20License%20Management/Traffic%20admin/welcome.php">Traffic Admin</a></li>
          </ul>
        </li>
        <li><a href="../User about.html">About</a></li>
      </ul>
    </div>
    <a href="../index.html" class="logo"><img class="w-10" src="../logo/logowhite.png"></a>
    <a href="../index.html" class="btn btn-ghost normal-case text-xl">D.L.M system</a>
  </div>
...
<?php if ($no_case): ?>
<p class="text-xl border-b-2 border-gray-200 pb-3 mb-2">Not found in the Case for you. (Safe journey)</p>
<?php else: ?>
<section class="border border-gray-200 rounded-2xl p-5 mb-10">
  <h2 class="text-2xl font-semibold mb-10 text-center">Case Details</h2>
  ...
  <div class="flex justify-center">
    ...
    <button class="btn border-2 border-white text-white hover:border-green-500 hover:text-green-500" onclick="my_modal_4.showModal()">Pay Online</button>
    ...
    <h3>Your Payable Amount: <?php echo $fine; ?> Tk</h3>
    </div>
